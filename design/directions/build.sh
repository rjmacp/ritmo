#!/bin/bash
set -e
# theme: NAME TITLE BG SURFACE BORDER TEXT MUTED ACCENT ACCENT_TEXT DISPLAY_FONT BODY_FONT MONO GFONT RADIUS SHADOW
gen() {
...
# A · Paper — warm editorial light, serif display, sage accent
gen Main "Paper" "#f6f2ea" "#fffdf8" "#e6dfd2" "#1f1d1a" "#7a7468" "#3f6b4f" "#fffdf8" "'Instrument Serif', Georgia, serif" "'Source Sans 3', system-ui, sans-serif" "'IBM Plex Mono', ui-monospace, monospace" "family=Instrument+Serif&family=Source+Sans+3:wght@400;600&family=IBM+Plex+Mono:wght@400;500" "6px" "none" "#e8e2d4" "#3f6b4f" "#b4552f" "#fffdf8" \
 "<div class=\"num\" style=\"font-size: 30px; font-style: italic; font-weight: 400; color: #1f1d1a;\">Ritmo</div>" > Main.dc.html

# B · Track — cool light, geometric grotesk, electric blue
gen Track "Track" "#eef1f5" "#ffffff" "#dde2ea" "#0f172a" "#64748b" "#1d4ed8" "#ffffff" "'Space Grotesk', system-ui, sans-serif" "'Space Grotesk', system-ui, sans-serif" "'Space Mono', ui-monospace, monospace" "family=Space+Grotesk:wght@400;500;700&family=Space+Mono:wght@400" "14px" "0 1px 2px rgba(15,23,42,.04)" "#dbe4f3" "#15803d" "#c2410c" "#ffffff" \
 "<div class=\"num\" style=\"font-size: 22px; letter-spacing: -.03em; color: #1d4ed8;\">RITMO</div>" > Track.dc.html

# C · Dusk — soft dark navy, mint accent, Manrope
gen Dusk "Dusk" "#151a24" "#1c2230" "#27303f" "#e6eaf2" "#8a94a8" "#5eead4" "#0f172a" "'Manrope', system-ui, sans-serif" "'Manrope', system-ui, sans-serif" "'JetBrains Mono', ui-monospace, monospace" "family=Manrope:wght@400;600;800&family=JetBrains+Mono:wght@400;500" "12px" "none" "#2a3342" "#5eead4" "#fbbf24" "#1c2230" \
 "<div class=\"num\" style=\"font-size: 22px; font-weight: 800; color: #e6eaf2;\">ritmo<span style=\"color: #5eead4;\">.</span></div>" > Dusk.dc.html

# D · Signal — bright white, coral blocks, Outfit rounded
gen Signal "Signal" "#ffffff" "#f7f7f8" "#ececef" "#111114" "#6f6f78" "#e4573d" "#ffffff" "'Outfit', system-ui, sans-serif" "'Outfit', system-ui, sans-serif" "'DM Mono', ui-monospace, monospace" "family=Outfit:wght@400;500;700&family=DM+Mono:wght@400;500" "18px" "none" "#fde8e3" "#1f9d5c" "#e4573d" "#ffffff" \
 "<div class=\"num\" style=\"font-size: 24px; color: #111114;\">Ritmo</div>" > Signal.dc.html

cat > canvas.json <<EOF
{
  "artboards": [
    { "file": "Main.dc.html", "title": "A · Paper", "x": 0, "y": 0, "w": 390, "h": 844 },
    { "file": "Track.dc.html", "title": "B · Track", "x": 470, "y": 0, "w": 390, "h": 844 },
    { "file": "Dusk.dc.html", "title": "C · Dusk", "x": 940, "y": 0, "w": 390, "h": 844 },
    { "file": "Signal.dc.html", "title": "D · Signal", "x": 1410, "y": 0, "w": 390, "h": 844 }
  ],
  "annotations": [
    { "id": "a-note", "x": 0, "y": -150, "w": 390, "text": "A · Paper\nWarm off-white, italic serif numerals, sage green. Calm training-journal feel. Trade-off: least 'sporty'; serif numbers are less scannable mid-run." },
    { "id": "b-note", "x": 470, "y": -150, "w": 390, "text": "B · Track\nCool light grey, Space Grotesk everywhere, electric blue. Data-first and crisp; closest to a Garmin/Strava sensibility without copying either. Trade-off: most conventional." },
    { "id": "c-note", "x": 940, "y": -150, "w": 390, "text": "C · Dusk\nStill dark, but soft navy instead of black and mint instead of orange. Easiest on the eyes at night, charts pop. Trade-off: dark again — if the theme itself is the problem, skip." },
    { "id": "d-note", "x": 1410, "y": -150, "w": 390, "text": "D · Signal\nPure white, rounded Outfit type, coral as the one loud colour. Friendly and motivating; most 'consumer app'. Trade-off: coral is in the orange family; the large radii can feel toy-like with dense data." }
  ],
  "launch": { "view": "canvas" }
}
EOF
